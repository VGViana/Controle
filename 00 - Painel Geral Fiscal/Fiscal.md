...
```mermaid
graph TD
  WarRoom[WAR ROOM] --> Metodologia[Metodologia de Guerra]
  WarRoom --> Jurisprudencia[Jurisprudência STF/STJ]
  WarRoom --> LALUR[LALUR e Lucro Real]
  WarRoom --> SPED[SPED e TI]
  LALUR --> Contabilidade
  LALUR --> Tributario
  Jurisprudencia --> Tributario
  Jurisprudencia --> Constitucional
  style WarRoom fill:#f96,stroke:#333,stroke-width:4px
```