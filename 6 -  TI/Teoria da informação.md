...
- **Dado -** Embora as palavras **dado** e **informação** sejam utilizadas como sinônimos, esses dois conceitos possuem diferentes significados na Gestão da Informação. De forma geral, **dado** é qualquer registro solto, sem qualquer significado, ou seja, são fatos brutos sem qualquer contexto;

- **Informação -** De forma complementar, quando os dados estão estruturados em um contexto, e estão organizados e processados, esses dados **geram informação**.
