...
1. **Base de Cálculo** das Participações = **Resultado Líquido Antes das Participações - Prejuízos Acumulados** (se houver)
2. Cálculo das Participações **Necessariamente na Ordem** (DEAPF), conforme o percentual indicado na questão.
    - A **BC** de cada um dos itens deve ser **deduzida da participação** do grupo imediatamente **anterior.**

**Outras Receitas** (Exemplos):

- receitas com reversão de perdas estimadas na realização de **Investimentos.**
- receitas decorrentes da alienação de bens do **Ativo Não Circulante Imobilizado.**
