...
- **1. Corpóreos (materiais, tangíveis ou concretos):** são os que têm existência física; podem ser tocados (ex.: terreno, casa, carro, livro, joia).
- **2. Incorpóreos (imateriais, intangíveis ou abstratos):** são os que não podem ser percebidos pelos sentidos, mas possuem valor econômico, podendo ser objeto de direito (ex.: direitos autorais, propriedade industrial).
...
<mark style="background:rgba(240, 200, 0, 0.2)">**🚩 Observações:**</mark>
