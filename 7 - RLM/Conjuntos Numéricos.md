# **1. CONJUNTOS NUMÉRICOS E OPERAÇÕES BÁSICAS**

## **1.1 Adição**

### **1.1.1 Propriedades da Adição**

- Propriedade **<span style="color: #d79921"><u>Comutativa</u></span>**: A ordem dos números não afeta o resultado da adição. Em outras palavras, a adição pode ser realizada em qualquer ordem.
    - Exemplos:
        - a + b = b + a
        - 2 + 3 = 3 + 2
- Propriedade **<span style="color: #d79921"><u>Associativa</u></span>**: A forma como os números são agrupados não afeta o resultado da adição. Isso significa que podemos adicionar os números em diferentes grupos sem alterar a soma total.
    - Exemplos:
        - (a + b) + c = a + (b + c)
        - (2 + 3) + 4 = 2 + (3 + 4)
- **<span style="color: #d79921"><u>Elemento Neutro</u></span>** da Adição: Existe um número chamado de elemento neutro da adição que, quando adicionado a qualquer número, não altera seu valor. Esse número é o zero (0).
    - Exemplos:
        - a + 0 = a
        - 5 + 0 = 5
- **<span style="color: #d79921"><u>Inverso Aditivo</u></span>**: Para cada número, existe um número que, quando adicionado a ele, resulta no elemento neutro da adição (zero). Esse número é chamado de inverso aditivo ou oposto.
    - Exemplo:
        - a + (-a) = 0
        - 3 + (-3) = 0
- **<span style="color: #d79921"><u>Fechamento</u></span>**: A propriedade do fechamento da adição de números naturais afirma que a adição de dois números naturais resultará sempre em um número natural.

## **1.2 Relação Fundamental da subtração**

- **Já sabemos que a subtração é representada da seguinte forma**
	- **<span style="color: #d79921">Minuendo – Subtraendo = Diferença</span>**
	
- **Temos que observar que os elementos da subtração também podem estar em outra formatação, mas ainda respeitando a relação:** 
	- **<span style="color: #d79921">Minuendo = Subtraendo + Diferença</span>**

### **1.2.1 Relação entre adição e subtração**

- **A adição e a subtração são operações inversas, ou seja, se você adiciona um número a outro e, em seguida, subtrai o mesmo número do resultado, teremos de volta o valor original.**
- **Ou seja, você adiciona 5 a 3 e, em seguida, subtrai 5 do resultado (8 - 5), você volta a ter 3.**
- Exemplos: 
	- a + b = c  ->  c - b = a
	- 10 + 4 = 14  -> 14 - 4 = 10

### **1.2.2 Propriedades da subtração** 

- **Somando ou subtraindo o mesmo número do minuendo e do subtraendo, a diferença permanece a mesma, sem alteração de valor. Vejamos:**      
    - (a) – (b) = c
    - (a + k) - (b + k) = a + k - b - k  -> a - b = c
- Utilizando números: 
	- 10 - 5 = 5
	- (10 + 81) - (5 + 81) = 10 + 81 - 5 -81  ->  10 - 5 = 5

### **1.2.3 Algoritmo da Subtração** 

- **Podemos ter situações distintas durante uma subtração.** Quando estivermos diante de uma <u>subtração onde o algarismo que compõe o minuendo for maior que algarismo que compõe o subtraendo</u>**, realiza-se uma <span style="color: #d79921"><u>subtração comum</u></span>, subtraindo o número de cima pelo de baixo, veja o exemplo:**

![Conjuntos Numéricos](Images/Conjuntos%20Num%C3%A9ricos.png)

**Entretanto, pode acontecer exatamente o inverso e o minuendo possuir números menores que os do subtraendo. Dessa forma, precisaremos utilizar outra estratégia, temos duas opções:**

**1) Em vez de subtrair o menor número do maior, iremos emprestar 1 da dezena e adicioná-la à unidade. Assim, o número que recebeu o empréstimo converte-se em dezena e retiramos uma unidade do número que cedeu o empréstimo. Vejamos através do exemplo referente à subtração de (25-18):**

![Conjuntos Numéricos-1](Images/Conjuntos%20Num%C3%A9ricos-1.png)

**2) Podemos adicionar uma dezena à unidade do minuendo e para compensar, também adicionar uma unidade ao próximo número do subtraendo. Vejamos o exemplo com os mesmos números utilizados na opção 1):**

![Conjuntos Numéricos-2](Images/Conjuntos%20Num%C3%A9ricos-2.png)

## **1.4. Multiplicação**

- É uma operação que utilizamos para facilitar o cálculo da **adição sucessiva de um número por ele mesmo**. Por exemplo:
    - <span style="color: #d79921">4 + 4 + 4 + 4 + 4 + 4 + 4</span> **= <span style="color:#b8bb26">28</span>**
    - A adição sucessiva de 4 por ele mesmo 7 vezes pode ser representada de forma mais simples, a saber:
        - <span style="color: #d79921">4 × 7</span> **= <span style="color:#b8bb26">28</span>**

### **1.4.1 Terminologia e símbolos** 

- A multiplicação é representada pelo símbolo "×" (uma cruz) ou pelo símbolo "⋅" (um ponto central), ambos colocados entre os números ou expressões que estão sendo multiplicados. Vejamos:
	- 2 **×** 3 = 6
	- 4 **⋅** 5 = 20
- Por fim, também é comum a não utilização de símbolos, principalmente no contexto de multiplicação envolvendo variáveis representadas por letras. Nesse caso, apesar de não existir a representação textual do símbolo de multiplicação, ele está presente ocultamente, vejamos:
	- 3a + 2b = (3 **⋅** a) + (2 **⋅** b)
	- XYZ + 25 = X **⋅** Z **⋅** Y + 25

### **1.4.2 Propriedades da multiplicação**

- Propriedade **<span style="color: #d79921"><u>Comutativa</u></span>:** A <u>ordem dos números não afeta o resultado da multiplicação.</u> Em outras palavras, a multiplicação pode ser realizada em qualquer ordem.
    - Exemplos:
	    - a.b=b.a
	    - 2.3=3.2
...
![Conjuntos Numéricos-3](Images/Conjuntos%20Num%C3%A9ricos-3.png)
...
![Conjuntos Numéricos-4](Images/Conjuntos%20Num%C3%A9ricos-4.png)
...
![Conjuntos Numéricos-5](Images/Conjuntos%20Num%C3%A9ricos-5.png)
...
![Conjuntos Numéricos-6](Images/Conjuntos%20Num%C3%A9ricos-6.png)
...
- Aqui vão algumas dicas para facilitar as operações com frações:  
    ...
    2) Temos que ter em mente algumas relações que nos economizarão tempo, vejamos:

![Conjuntos Numéricos-7](Images/Conjuntos%20Num%C3%A9ricos-7.png)
...
Por fim, imagine que você tenha que realizar a seguinte operação:

![Conjuntos Numéricos-8](Images/Conjuntos%20Num%C3%A9ricos-8.png)
...
![Conjuntos Numéricos-9](Images/Conjuntos%20Num%C3%A9ricos-9.png)
...
![Conjuntos Numéricos-10](Images/Conjuntos%20Num%C3%A9ricos-10.png)
...
![Conjuntos Numéricos-11](Images/Conjuntos%20Num%C3%A9ricos-11.png)
...
![Conjuntos Numéricos-12](Images/Conjuntos%20Num%C3%A9ricos-12.png)

⚠️ Alguns pontos importantes sobre potenciação incluem:

- Quando a base é elevada ao **expoente 0**, o resultado é sempre 1. Por exemplo:

![Conjuntos Numéricos-13](Images/Conjuntos%20Num%C3%A9ricos-13.png)
...
![Conjuntos Numéricos-14](Images/Conjuntos%20Num%C3%A9ricos-14.png)
...
![Conjuntos Numéricos-15](Images/Conjuntos%20Num%C3%A9ricos-15.png)

- **Potência de base fracionária**: Neste caso, podemos elevar tanto o numerador quanto o denominador a um expoente. Por exemplo:

![Conjuntos Numéricos-16](Images/Conjuntos%20Num%C3%A9ricos-16.png)
...
![Conjuntos Numéricos-17](Images/Conjuntos%20Num%C3%A9ricos-17.png)
...
![Conjuntos Numéricos-18](Images/Conjuntos%20Num%C3%A9ricos-18.png)
...
![Conjuntos Numéricos-19](Images/Conjuntos%20Num%C3%A9ricos-19.png)
...
![Conjuntos Numéricos-20](Images/Conjuntos%20Num%C3%A9ricos-20.png)

- ⚠️Obs.: Cuidado para não confundir a última propriedade com o caso abaixo. Os parênteses pode fazer toda diferença.

![Conjuntos Numéricos-21](Images/Conjuntos%20Num%C3%A9ricos-21.png)
...
![Conjuntos Numéricos-22](Images/Conjuntos%20Num%C3%A9ricos-22.png)
...
![Conjuntos Numéricos-23](Images/Conjuntos%20Num%C3%A9ricos-23.png)
...
![Conjuntos Numéricos-24](Images/Conjuntos%20Num%C3%A9ricos-24.png)
...
![Conjuntos Numéricos-25](Images/Conjuntos%20Num%C3%A9ricos-25.png)
...
- **Exemplo:**
    - Calcule o MDC(132,120)
        - Vamos decompor os números.
![Conjuntos Numéricos-26](Images/Conjuntos%20Num%C3%A9ricos-26.png)
