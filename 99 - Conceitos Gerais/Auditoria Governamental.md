...
- **Finalidade**: Avaliar a gestão pública (**[[5. Poderes e Deveres#1. Definições:|Eficiência e Economicidade]]**.md).
...
- **Integração**: Para a relação entre Auditoria e Lançamento, veja: **[[Conexões de Direito Público|Conexões de Direito Público]]**.
