...
**⚠️ <mark style="background:#ff4d4f">Atenção**: A desconsideração deve ser requerida, **não pode ser** _**ex officio** (sem provocação)!</mark> 
...
**TEORIA MAIOR X TEORIA MENOR DA DESCONSIDERAÇÃO**
