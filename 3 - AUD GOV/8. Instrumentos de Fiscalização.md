...
| ----------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **Economicidade** | Gastos         | Minimização dos custos mantendo qualidade. Usa bem os recursos disponíveis.                                                |
| **Eficiência**    | Produção       | Relação entre insumos e produtos gerados. Medida por custo unitário, tempo e recursos.                                     |
| **Eficácia**      | Metas          | Grau de alcance das metas, **independente do custo**. Refere-se a **objetivos imediatos**.                                 |
| **Efetividade**   | Impacto        | Avaliação dos **efeitos de médio/longo prazo** na população-alvo (impacto real).                                           |
...
![[8. Instrumentos de Fiscalização-1.png]]